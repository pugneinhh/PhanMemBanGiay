...
public class CustomTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void installDefaults() {
        ...
        selectColor = new Color(204,0,0);
        deSelectColor = new Color(255,153,153);
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        ...
        switch (tabPlacement) {
            ...
            default:
                ...
                gradientShadow = new GradientPaint(0, 0, Color.ORANGE, 0, y + h / 2, new Color(200,0,0));
                break;
        }
        // ;
        ...
        if (isSelected) {
            ...
            if (tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
                ...
                GradientPaint gradientShadowTmp = new GradientPaint(0, 0, new Color(255, 255, 200), 0, y + h / 2, new Color(255,153,51));
                g2D.setPaint(gradientShadowTmp);
            } else {
                GradientPaint gradientShadowTmp = new GradientPaint(0, 0, new Color(240, 255, 210), 0, y + 15 + h / 2, new Color(255,153,51));
                g2D.setPaint(gradientShadowTmp);
            }
        }
