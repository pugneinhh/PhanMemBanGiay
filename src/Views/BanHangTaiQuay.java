 ...
 * @author HoiVN
 */
public class BanHangTaiQuay extends javax.swing.JFrame {

    private ChiTietSanPhamService CTSPService;
    DefaultTableModel modelTable = new DefaultTableModel();
    /**
     * Creates new form BanHangTaiQuay
     */
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1320, 664));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanHangTaiQuay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BanHangTaiQuay().setVisible(true);
            }
        });
    }
