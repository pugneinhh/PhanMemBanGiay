        ...
        do {
            ...
            if (result != null) {
                ...
                if(ctsp!=null & ctsp.getMaQR()!=0){
                    JOptionPane.showConfirmDialog(this, "Đã tìm thấy sản phẩm "+ ctsp.getIdSP().getTenSP()+ ", size "+ctsp.getIdSize().getTenSize()+", màu "+ctsp.getIdMS().getTenMS()+", cao "+ctsp.getIdDC().getTenDC()+"cm"+"\n Bạn có muốn thêm sản phẩm này vào giỏ hàng không?");
                }
            }
        } while (true);
    }
