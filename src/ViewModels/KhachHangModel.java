...
public class KhachHangModel {
   private String idKH;
    ...
    public KhachHangModel(String idKH, String maKH, String loaiKH, String tenKH, String diaChi, String gioiTinh, String email, String sdt, Date ngaySinh, Date ngayThamGia, int tichDiem, int diemEXP, Date ngayTao, Date ngaySua, int trangThai) {
        this.idKH = idKH;
        this.maKH = maKH;
        this.loaiKH = loaiKH;
        this.tenKH = tenKH;
    ...
    public Object[] toDataRow(){
        return new Object[]{maKH,tenKH,loaiKH,diaChi,gioiTinh,
            email,sdt,ngaySinh,ngayThamGia,tichDiem,diemEXP,trangThai==1?"Còn hoạt động":"Ngừng hoạt động"           
        };
    }
}
